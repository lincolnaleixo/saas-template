...
- DO NOT RUN LINTER OR/AND TRY TO FIX TYPESCRIPT LINTING ERRORS
...
| Layer      | Technology                                                                  |
| ---------- | --------------------------------------------------------------------------- |
| Container  | Docker Compose with services: `frontend`, `api`, `scheduler`, `db`, `redis` |
| API        | Bun (TypeScript) with Hono framework and Zod schemas                        |
| Scheduler  | Bun worker with node-cron for scheduled jobs                                |
| Database   | **PostgreSQL**                                      |
| Cache      | Redis                                                                       |
| Frontend   | Native Web Components with Vanilla JS using Vite                            |
